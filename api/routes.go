...
func (s *server) routes() {
	...
	api.HandleFunc("/{account}/volumes", s.ProxyRequestHandler).Methods(http.MethodGet)
	api.HandleFunc("/{account}/volumes/{id}", s.ProxyRequestHandler).Methods(http.MethodGet)
	...
	api.HandleFunc("/{account}/snapshots", s.ProxyRequestHandler).Methods(http.MethodGet)
	api.HandleFunc("/{account}/snapshots/{id}", s.ProxyRequestHandler).Methods(http.MethodGet)
	api.HandleFunc("/{account}/subnets", s.ProxyRequestHandler).Methods(http.MethodGet)
	api.HandleFunc("/{account}/images", s.ProxyRequestHandler).Methods(http.MethodGet)
	api.HandleFunc("/{account}/images/{id}", s.ProxyRequestHandler).Methods(http.MethodGet)
