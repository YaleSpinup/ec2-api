...
func (s *server) routes() {
	...
	api.HandleFunc("/{account}/volumes/{id}", s.VolumesHandler).Methods(http.MethodPut)
	api.HandleFunc("/{account}/volumes/{id}/tags", s.VolumesTagsHandler).Methods(http.MethodPut)
